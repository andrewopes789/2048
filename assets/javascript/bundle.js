...
var _fetch_data = __webpack_require__(2);
...
zipSubmit.addEventListener('click', function (e) {
  ...
  if (!(parseInt(zipInput.value) > 9999 && parseInt(zipInput.value) < 99999)) {
...
var searchAbout = document.getElementById('searchAbout');

searchAbout.addEventListener('click', function (e) {
  e.preventDefault();
  header.style.display = 'flex';
  allAnalytics.style.display = 'none';
  selectArea.style.display = 'none';
